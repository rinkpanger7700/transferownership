...
export declare namespace drive_v3 {
    ...
    export class Drive {
        ...
        pendingActions: Resource$Pendingactions; // Only for testing.
        pendingOwnershipChanges: Resource$Pendingownershipchanges; // Only for testing.
        ownership: Resource$Ownership; // Only for testing.
